...
/**
 * Auto Blue Back 3 Ball - Simple Autonomous
 ...
 */
@Config
@Autonomous(name = "Auto Blue Back 3Ball", group = "Auto")
public class AutoBlueBack3Ball extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        telemetry.addLine("=== Auto Blue Back 3Ball ===");
